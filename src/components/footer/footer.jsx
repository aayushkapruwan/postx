...
function Footerx() {
  return (
      ...
      <Footer container className="flex justify-between shadow-amber-100  shadow-2xl  w-full items-center h-14 fixed bottom-0 bg-gray-900 text-white opacity-100 left-0">
