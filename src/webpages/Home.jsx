  ...
  if (!userdata || !userdata.email) {
    return (
      <div className="flex justify-center items-center 
                      h-screen md:h-screen sm:h-[calc(100vh-4rem)] w-full overflow-hidden">
        <div className="flex flex-col items-center text-center bg-white/10 backdrop-blur-xl p-8 rounded-2xl shadow-xl border border-white/20 animate-fade-in max-w-md w-full">
